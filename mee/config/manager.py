...
DEFAULT_CONFIG_DIR = Path.home() / ".config" / "medical_pipeline"
...
PROMPT_PROJECT_DIR = PROJECT_ROOT / "resources" / "prompt_engineering"
PROMPT_FALLBACK_DIR = DEFAULT_CONFIG_DIR.parent / "mee" / "resources" / "prompt_engineering"
